...
/** Obtains the number of sections in the dial from the delegate
 ...
 The delegate should return the number of sections that will appear in the dial control.
...
The FEDialControl object will request a UIImage object for each section of the dial control.  The image returned should be oriented according to the homePosition parameter specified in the FEDialControl initializer.  _See the demo for examples of different home positions._
...
/** Obtains the non-rotating interface image of the dial (in font of all other views)
 ...
 The FEDialControl object will request a UIImage object to be used as the foreground image.  This is useful for dial images that have a complex design with stationary graphics that sit on top of the rotating dial.
...
/** Obtains the button image for the center of the dial (optional)
 ...
 The FEDialControl object will request a UIImage object to be used to display a button located in the center of the dial.  
...
/** Obtains the depressed image for the center of the dial (optional)
 ...
 The FEDialControl object will request a UIImage object to be used to display the selected or depressed state of the button in the center of the dial.
...
/** Notify the delegate that the button was pressed
 ...
 The FEDialControl object will use this method to notify the delegate when the user has tapped the center button (if configured).
